...
xhr.open("GET", "https://api.vschool.io/jess/todo/", true)
//true is deafult, makes request acycronous running continuously 
xhr.send()

//so postman is just an easier way to do this
